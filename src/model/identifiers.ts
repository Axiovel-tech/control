...
export const missionItemIdToGlobalId = appendTo('missionItem$');
...
export const globalIdToMissionItemId = stripPrefix('missionItem$');
...
export const isMissionItemId = hasPrefix('missionItem$');
